export class PopulationHealthService {
    ...
    async calculateMetrics() {
        ...
        const diabetesCount = conditions.filter(c => c.code.icd10amCode === 'E11' ||
            c.code.snomedCode === '44054006' ||
            c.code.sourceCode.includes('سكري')).length;
        // 3. Immunization Coverage
        const fluCount = immunizations.filter(i => i.vaccineCode.cvxCode === '158' ||
            i.vaccineCode.sourceCode.includes('FLU') ||
            i.vaccineCode.sourceCode.includes('إنفلونزا')).length;
...
//# sourceMappingURL=population-health.js.map