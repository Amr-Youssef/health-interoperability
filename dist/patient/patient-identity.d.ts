 ...
 */
export declare const SOVEREIGN_READ_ONLY_FIELDS: readonly ["nationalId", "internalId", "birthDate", "gender", "firstName", "lastName", "firstNameAr", "lastNameAr", "username", "fullName", "role"];
export declare const ALLOWED_SELF_SERVICE_FIELDS: readonly ["phone", "email", "preferredFirstName", "preferredLastName", "preferredLanguage", "emergencyContactName", "emergencyContactPhone", "emergencyContactRelationship", "addressLine", "addressCity", "addressDistrict", "addressPostalCode", "notes"];
