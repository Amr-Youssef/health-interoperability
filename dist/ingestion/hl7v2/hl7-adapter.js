...
import { Hl7v2MessageParser } from './hl7-parser.js';
export class Hl7v2FeedAdapter {
    sourceSystemId = 'hl7v2-mllp-feed';
    sourceSystemName = 'HL7 v2.5 MLLP Network Ingestion Feed';
    adapterVersion = '1.0.0';
    parser = new Hl7v2MessageParser();
    queuedRecords = [];
     ...
     */
    processHl7Message(rawHl7, batchId) {
...
//# sourceMappingURL=hl7-adapter.js.map