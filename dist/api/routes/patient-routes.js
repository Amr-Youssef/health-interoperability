...
function normalizeSaudiPhoneEditable(raw) {
...
function isValidEmailEditable(email) {
...
function validateEditablePayload(body) {
    ...
    if (body.emergencyContactRelationship !== undefined) {
        ...
        if (v && !allowed.includes(v) && v !== '')
            return { valid: false, error: 'العلاقة غير صالحة: اختر من القيم المسموحة (PARENT, SPOUSE, SIBLING, CHILD, FRIEND, OTHER)' };
