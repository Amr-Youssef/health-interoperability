...
export class NphiesSandboxSimulator {
    gatewayUrl = 'https://sandbox.nphies.sa/fhir/ksa/nphies-fs';
    version = '1.0.0-sandbox';
    /**
     * Simulates real-time NPHIES Insurance Eligibility Inquiry
     */
    async checkEligibility(coverage) {
     ...
     */
    async adjudicateClaim(claim, coverage) {
...
//# sourceMappingURL=nphies-sandbox.js.map