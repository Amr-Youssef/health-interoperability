export class TerminologyService {
    ...
    findMappingByCodeOnly(code) {
        for (const [k, v] of this.localCodeMaps.entries()) {
            if (v.sourceCode.toLowerCase() === code.toLowerCase())
                return v;
        }
        return null;
    }
    buildClinicalCodeFromConcept(concept, sourceCode, sourceSystemId, sourceDisplay) {
