...
export const DEFAULT_MAPPINGS: MappingConfiguration[] = [
  // ==========================================
  ...
  },
  {
    ...
    targetCanonicalEntity: 'CanonicalClaim' as any,
    mappingVersion: '1.0.0',
    effectiveDate: '2026-01-01',
    status: 'ACTIVE',
    author: 'Financial Team',
  ...
  },
  {
    ...
    targetCanonicalEntity: 'CanonicalMedicationRequest' as any,
    mappingVersion: '1.0.0',
    effectiveDate: '2026-01-01',
    status: 'ACTIVE',
  ...
  },
  {
    ...
    targetCanonicalEntity: 'CanonicalAllergyIntolerance' as any,
    mappingVersion: '1.0.0',
    effectiveDate: '2026-01-01',
    status: 'ACTIVE',
    author: 'Integration Team',
  ...
  },
  {
    ...
    targetCanonicalEntity: 'CanonicalDiagnosticReport' as any,
    mappingVersion: '2.0.0',
    effectiveDate: '2026-01-01',
    status: 'ACTIVE',
    author: 'Integration Team',
