import { ValidationResult, ValidationIssue, ValidationDecision } from '../core/domain/types.js';
...
export class DataQualityEngine {
   ...
   */
  async validate(mapped: MappedEntityResult): Promise<ValidationResult> {
    ...
    // Decision Logic
    let decision: ValidationDecision = 'ACCEPTED';
  ...
  private validatePatient(data: Record<string, any>, sourceSystemId: string, issues: ValidationIssue[]) {
  ...
  private validateEncounter(data: Record<string, any>, sourceSystemId: string, issues: ValidationIssue[]) {
  ...
  private validateCondition(data: Record<string, any>, sourceSystemId: string, issues: ValidationIssue[]) {
  ...
  private validateObservation(data: Record<string, any>, sourceSystemId: string, issues: ValidationIssue[]) {
    if (!data.code || !data.code.sourceCode) {
      issues.push({
        field: 'code',
        severity: 'ERROR',
  ...
  private validateCoverage(data: Record<string, any>, sourceSystemId: string, issues: ValidationIssue[]) {
  ...
  private validateClaim(data: Record<string, any>, sourceSystemId: string, issues: ValidationIssue[]) {
  ...
  private validateMedicationRequest(data: Record<string, any>, sourceSystemId: string, issues: ValidationIssue[]) {
  ...
  private validateImmunization(data: Record<string, any>, sourceSystemId: string, issues: ValidationIssue[]) {
    if (!data.vaccineCode) {
      issues.push({
        field: 'vaccineCode',
        severity: 'ERROR',
  ...
  private validateAllergyIntolerance(data: Record<string, any>, sourceSystemId: string, issues: ValidationIssue[]) {
  ...
  private validateDiagnosticReport(data: Record<string, any>, sourceSystemId: string, issues: ValidationIssue[]) {
    if (!data.code) {
      issues.push({
        field: 'code',
        severity: 'ERROR',
