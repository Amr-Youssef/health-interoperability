...
function ensurePatientOwnership(req: Request, res: Response, next: NextFunction) {
...
router.patch('/me/profile', async (req, res) => {
  try {
    const patientId = req.user!.patient_profile_id!;
    const profileData: Partial<PatientProfileData> = {
...
router.patch('/me/allergies/:allergyId', async (req, res) => {
  try {
    ...
    const allergyData: Partial<PatientReportedAllergyData> = {
      allergenName: req.body.allergenName,
      reactionText: req.body.reactionText,
      reactionSeverity: req.body.reactionSeverity,
      notes: req.body.notes,
...
router.patch('/me/medications/:medicationId', async (req, res) => {
  try {
    ...
    const medicationData: Partial<PatientReportedMedicationData> = {
      medicationName: req.body.medicationName,
      dose: req.body.dose,
      frequency: req.body.frequency,
...
router.post('/me/conditions', async (req, res) => {
  try {
    ...
    const conditionData: PatientReportedConditionData = {
      patientId,
...
router.patch('/me/conditions/:conditionId', async (req, res) => {
  try {
    ...
    const conditionData: Partial<PatientReportedConditionData> = {
      conditionName: req.body.conditionName,
      status: req.body.status,
      notes: req.body.notes,
    };
...
router.post('/me/procedures', async (req, res) => {
  try {
    ...
    const procedureData: PatientReportedProcedureData = {
      patientId,
...
router.patch('/me/procedures/:procedureId', async (req, res) => {
  try {
    ...
    const procedureData: Partial<PatientReportedProcedureData> = {
      procedureName: req.body.procedureName,
      facilityName: req.body.facilityName,
      notes: req.body.notes,
    };
...
router.patch('/me/family-history/:familyId', async (req, res) => {
  try {
    ...
    const familyData: Partial<FamilyMemberData> = {
      relativeName: req.body.relativeName,
      conditionName: req.body.conditionName,
      notes: req.body.notes,
    };
...
router.post('/me/social-history', async (req, res) => {
  try {
    ...
    const socialData: Partial<PatientReportedSocialHistoryData> = {
...
router.get('/me/vitals', async (req, res) => {
  try {
    const patientId = req.user!.patient_profile_id!;
    const observationType = req.query.type as string | undefined;
...
router.post('/me/vitals', async (req, res) => {
  try {
    ...
    const vitalData: PatientReportedVitalObservationData = {
      patientId,
...
router.post('/me/documents', async (req, res) => {
  try {
    ...
    const documentData: PatientUploadedDocumentData = {
      patientId,
